...
class MPC(Node):
    ...
    def __init__(self):
        ...
        self.drive_pub = self.create_publisher(AckermannDriveStamped, '/drive', 10) #publishes message type Ackermann over topic "/drive"
        ...
        # get waypoints
        filename = '/sim_ws/src/mpc/data/robot_log_with_velocities.csv'
        ...
        self.waypoints[:,2] = np.unwrap(self.waypoints[:,2])
    ...
    def pose_callback(self, pose_msg):
        ...
        vehicle_state.yaw = np.unwrap(euler[2])
        # print(vehicle_state.yaw)
